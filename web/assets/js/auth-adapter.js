...
(function configurarPortalAuthAdapter(global) {
  ...
  function getCurrentSession() {
    ...
    return {
      ...
      nomeExibicao: usuario.nomeExibicao || (autenticado ? 'Usuário GEAPA' : 'Visitante'),
      email: usuario.email || '',
      ...
      modoAcesso: usuario.modoAcesso || '',
      motivoBloqueio: usuario.motivoBloqueio || '',
      mensagemBloqueio: usuario.mensagemBloqueio || '',
  ...
  function normalizarSessaoResolvida(sessao) {
    ...
    return {
      ...
      nomeExibicao: dados.nomeExibicao || (autenticado ? 'Usuário GEAPA' : 'Visitante'),
      email: dados.email || '',
