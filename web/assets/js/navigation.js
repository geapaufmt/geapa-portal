...
(function configurarNavegacaoPortal(global) {
  ...
  var ROTAS_PORTAL = [
    ...
    rota('processo-seletivo', 'Processo seletivo', 'processo-seletivo', 'publico', 70, 'tela-placeholder', 'view-placeholder', false, PUBLICO, [], 'Informações públicas sobre ingresso e processo seletivo.', 'placeholder'),
    rota('contato', 'Contato', 'contato', 'publico', 80, 'tela-placeholder', 'view-placeholder', false, PUBLICO, [], 'Canais públicos de contato do GEAPA.', 'placeholder'),
    rota('login', 'Entrar', 'login', 'publico', 90, 'tela-acesso', 'view-login', false, PUBLICO, [], 'Entrada por Google ou código temporário.', 'implementado', false),
    rota('interesse', 'Tenho interesse', 'interesse', 'publico', 100, 'tela-placeholder', 'view-placeholder', false, PUBLICO, [], 'Formulário futuro para cadastro de interesse sem conceder acesso interno automaticamente.', 'placeholder'),
    ...
    rota('historico-atividades', 'Histórico de atividades', 'agenda/historico-atividades', 'agenda', 30, 'tela-placeholder', 'view-placeholder', true, [PERFIS.MEMBRO, PERFIS.DIRETORIA, PERFIS.SECRETARIA, PERFIS.COMUNICACAO, PERFIS.CONSELHO, PERFIS.ADMIN], [], 'Histórico interno de atividades realizadas. Participações externas ficam em Meu Vínculo.', 'placeholder'),
