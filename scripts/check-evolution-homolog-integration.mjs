...
required(/portal-geapa-pwa-v122/.test(sw), 'Cache PWA nao foi incrementado.');
...
required(index.includes('style.css?v=60') && index.includes('api.js?v=52') && index.includes('app.js?v=37'), 'Cache-busters finais nao foram atualizados.');
